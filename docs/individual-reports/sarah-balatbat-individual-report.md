...
- Decryption puzzle
  ...
  - Created font files for ease of use in design with Figma -- the font is called ReCollect Enscrypt, created with [Calligraphr](https://www.calligraphr.com)
    - [Open Type Font file](/assets/week8/sarah/RecollectEnscrypt-Regular.otf)
    - [True Type Font file](/assets/week8/sarah/RecollectEnscrypt-Regular.ttf)
...
- Finalized sketches
  - Mouse -- loosely based on a low poly mouse model reference from [week 5]({{ '/project-spec/sarah-balatbat-individual-report/#week-5' | relative_url}})
...
- Reference sheets made
  - Gurf -- based on rotund cat references from [week 5]({{ '/project-spec/sarah-balatbat-individual-report/#week-5' | relative_url}})
