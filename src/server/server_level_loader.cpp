...
void loadLevel(ServerGame& game, entt::registry& registry) {
  ...
  registry.emplace<shared::SectionController>(winterSection, 
	...
	registry.emplace<shared::Position>(sectionDoor, 100.0f, 100.0f, 100.0f, 1.0f, 0.0f, 0.0f, 0.0f);
	registry.emplace<shared::SectionDoorComponent>(sectionDoor,
		shared::DoorState::CLOSED,
