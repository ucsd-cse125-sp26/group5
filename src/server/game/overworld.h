...
// If Winter is completed, count OverworldTag entities with Position in
...
// Requires switch on, parent matching door entity id, Winter completed. Opens
// door, unlocks Fall, season -> FALL.
