...
inline std::unordered_map<ComponentTypeId, ComponentMeta>&
...
inline void registerAllSyncedComponents() {
  ...
  // registerComponent<Velocity>(CID_VELOCITY);  // uncomment to sync velocity
  // too registerComponent<Health>(CID_HEALTH);       // future components: one
  // line
}
