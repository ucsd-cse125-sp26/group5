...
using CloneFn = std::function<void(entt::registry& src, entt::entity srcEnt, entt::registry& dst, entt::entity dstEnt)>;
 ...
 public:
  ...
  void registerComponent(ComponentTypeId id) {
    meta_[id] = ComponentMeta{[](entt::registry& r, entt::entity e, std::vector<uint8_t>& buf) -> bool {
                              ...
                              [](entt::registry& src, entt::entity srcEnt, entt::registry& dst, entt::entity dstEnt) {
...
inline void cloneRegistry(const ComponentRegistry& compReg, entt::registry& src,
                          const std::map<uint32_t, entt::entity>& srcMap, entt::registry& dst,
